...
<link
	href="<%=request.getContextPath()%>/resources/css/recruit/recruitSearch.css"
					...
					<div id="searchbox">
							...
							<div id="districtcode">
								<div id="si_box">
									<ul id="si">
										...
										<li class="is"><input type="hidden" value="${city}"class="sikey"><a href="javascript:void(0)" class="si_a" title="${siname[city]}" media="${city}">${siname[city]}</a></li>
										</c:forEach>
									</ul>
								</div>
							<div id="gu_box">
						...
						<fieldset class="common">
							...
							<div class="selbox">
								...
								<input type="radio" name="w_day" value="주6일 월~토 ">주6일
								월~토 <input type="radio" name="w_day" value="주5일 월~금">주5일
								월~금 <input type="radio" name="w_day" value="주말 토~일">주말
								토~일
							</div>
						</fieldset>
						...
						<fieldset class="common">
							<h3>급여</h3>
							<div class="selbox">
								<input type="radio" name="salary" value="시급">시급 &nbsp; <input
									type="radio" name="salary" value="일급">일급&nbsp; <input
									type="radio" name="salary" value="주급">주급&nbsp; <input
									type="radio" name="salary" value="월급">월급&nbsp; <input
									type="radio" name="salary" value="연봉">연봉 &nbsp;
							</div>
						</fieldset>
						...
						<fieldset class="common">
							...
							<div class="selbox">
								<input type="radio" name="gender" value="남자">남자 &nbsp; <input
									type="radio" name="gender" value="여자">여자 &nbsp; <input
									type="checkbox" name="gen" value="무관">무관
							</div>
						</fieldset>
						...
						<fieldset class="common">
							<h3>연령</h3>
							<div class="selbox">
								<input type="text" size="5" value="" id="age">세&nbsp; <input
						...
						<fieldset class="common" id="school">
							<h3>학력</h3>
							<div class="selbox">
								&nbsp;<input type="checkbox" name="school" value="초등학교졸업"
									class="spec">초등학교졸업 &nbsp;<input type="checkbox"
									name="school" value="중학교졸업" class="spec">중학교졸업 &nbsp;<input
									type="checkbox" name="school" value="고등학교졸업" class="spec">고등학교졸업
								&nbsp;<input type="checkbox" name="school" value="전문대졸업"
									class="spec">전문대졸업 &nbsp;<input type="checkbox"
									name="school" value="4년제졸업" class="spec">4년제졸업 &nbsp;<input
									type="checkbox" name="school" value="대학원졸업" class="spec">대학원졸업
								&nbsp;<input type="checkbox" name="school" value="대학교재학"
									class="spec">대학교재학 &nbsp;<input type="checkbox"
									name="school" value="대학교휴학" class="spec">대학교휴학
							</div>
						</fieldset>
						...
						<fieldset class="common">
							...
							<div id="special" class="selbox">
								<a href="javascript:void(0)" id="woodae">우대사항을 선택하세요 (최대 2개
									가능)</a>
							</div>
							<div id="speckind">
								<ul>
						...
						<fieldset class="common">
							...
							<div class="selbox">
								<input type="text" size="40" style="width: 200px; height: 20px;"
									name="title" id="keyword">&nbsp; <input type="checkbox"
									name="word" value="회사명" checked="checked" class="key">회사명&nbsp;
								<input type="checkbox" name="word" value="채용제목"
									checked="checked" class="key">채용제목
							</div>
						</fieldset>
