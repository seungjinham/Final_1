...
<form id="form">
<div id="searchbox">
<fieldset class="common"><h3>지역</h3><div id="area" class="selbox">지역을 선택하세요 (최대 2개 가능)</div></fieldset>

<fieldset class="common"><h3>직종-업종</h3><div id="jobwork" class="selbox">직종-업종을 선택하세요 (최대 2개)</div></fieldset>
...
<fieldset class="common"><h3>우대조건</h3><div id="special" class="selbox">우대사항을 선택하세요 (최대 2개 가능)</div></fieldset>

<fieldset class="common"><h3>키워드</h3>
<div class="selbox">
<input type="text" size="40" style="width:200px; height:20px;">&nbsp;
<input type="checkbox">회사명&nbsp;
<input type="checkbox">채용제목
</div>
</fieldset>
